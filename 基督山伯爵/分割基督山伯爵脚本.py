...
def 分割基督山伯爵文本():
    """分割基督山伯爵文本文件，按照章节创建小文件"""
    
    # 源文件路径
    源文件路径 = r'd:\AI\books\ji_du_shan_bo_jue\基督山伯爵.txt'
    # 输出目录
    输出目录 = r'd:\AI\books\ji_du_shan_bo_jue\章回'
    ...
    章节正则 = re.compile(r'^[^（]*第([○零一二三四五六七八九十百千万\d]+)章[^）]*$')
