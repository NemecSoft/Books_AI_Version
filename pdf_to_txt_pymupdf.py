...
def pdf_to_txt_pymupdf(pdf_path, txt_path=None, start_page=0, end_page=None):
    """
    使用PyMuPDF将PDF文件转换为TXT文件
...
if __name__ == "__main__":
    ...
    txt_file = r"d:\AI\books\二十四史\《二十四史全译 三国志 第二册》主编：许嘉璐_pymupdf.txt"
    
    try:
        pdf_to_txt_pymupdf(pdf_file, txt_file)
    except Exception as e:
        print(f"操作失败: {e}")
        sys.exit(1)
